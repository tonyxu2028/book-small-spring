...
public class DisposableBeanAdapter implements DisposableBean {
    ...
    public void destroy() throws Exception {
        ...
        boolean isDestroyMethodName = !(bean instanceof DisposableBean && DESTROY_METHOD_NAME.equals(this.destroyMethodName));
        // 2. 注解配置 destroy-method {判断是为了避免二次执行销毁}
        if (StrUtil.isNotEmpty(destroyMethodName) && isDestroyMethodName) {
