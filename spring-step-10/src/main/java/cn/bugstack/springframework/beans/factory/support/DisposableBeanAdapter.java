...
public class DisposableBeanAdapter implements DisposableBean {
    ...
    public void destroy() throws Exception {
        ...
        boolean isDefaultDestroyMethod = !(bean instanceof DisposableBean && DESTROY_METHOD_NAME.equals(this.destroyMethodName));
        if (StrUtil.isNotEmpty(destroyMethodName) && isDefaultDestroyMethod) {
